...
class Menu(BoxLayout):
    ...
    def __init__(self,table='', **kwargs):
        ...
        """"""
        button = Button(text ='Informações de arquivos', size_hint =(1, .25),
                    pos =(200, 200))
        self.add_widget(button)
        button.bind(on_press=self.switch)

        button = Button(text ='Informações de processos', size_hint =(1, .25),
                    pos =(200, 200))
        self.add_widget(button)
        button.bind(on_press=self.switch)

        button = Button(text ='Informações gerais', size_hint =(1, .25),
                    pos =(200, 200))
        self.add_widget(button)
        button.bind(on_press=self.switch)

        button = Button(text ='Informações de rede', size_hint =(1, .25),
                    pos =(200, 200))
        self.add_widget(button)
        button.bind(on_press=self.switch)
